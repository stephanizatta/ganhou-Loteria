      ...
      *>----Variaveis de trabalho
       ...
       01  ws-tempo.
           05  ws-tempo-inicio                     pic 9(08).
           05  ws-tempo-fim                        pic 9(08).
           05  ws-tempo-gasto-total                pic 9(08).


       77  ws-quantia-numeros                      pic 9(02).
       77  ws-num-aux                              pic 9(02).
       77  ws-pontos                               pic 9(02).
       77  ws-rodada                               pic 9(18).
      ...
      *>------------------------------------------------------------------------
       processamento section.
           ...
           accept ws-tempo-inicio from time
      ...
      *>------------------------------------------------------------------------
      *>  Coleta a quantia de numeros para aposta
      *>------------------------------------------------------------------------
      ...
      *>------------------------------------------------------------------------
       ...
       *> verifica se os numeros apostados são iguais aos sorteados
        ...
        *> verifica sexto numero sorteado
           ...
           display " "
       *> só é apresentado na primeira rodada
      ...
      *>------------------------------------------------------------------------
       ganhou section.
       *> aqui fará com que o programa rode até os 6 numeros sorteados serem iguais aos apostados

           perform sorteio until ws-pontos = 6

           if ws-pontos = 6 then
               accept ws-tempo-fim from time
               compute ws-tempo-gasto-total = ws-tempo-fim - ws-tempo-inicio

               display "Tempo aproximadamente gasto no sorteio: " ws-tempo-gasto-total
               display "***Você ficou milionario!!!!***"
